...
\begin{enumerate}[label=(\alph*)]
    ...
    \item $\wrote(Gershwin, TheManILove) \land \wrote(McCartney, TheManILove)$ %c
    \item $\exists s \wrote(Joe, s)$ %d
    \item $\owns2(Joe, d) \land \copyof(d, Revolver)$ %e
    ...
    \item $\exists a \forall s \wrote(Joe, s)$ %i
    \item $\owns2(Joe, d) \land \copyof(d, a) \land \sings(BHoliday, s, a)$ %j
    \item $\exists d_i \copyof(d_i, a) \forall a \sings(McCartney, a, s) \rightarrow \forall  \owns2(Joe, d)$ %k
    \item $\exists d \copyof(d, a) \forall a \sings(BHoliday, s, a) \rightarrow \owns2(Joe, d)$ %l
\end{enumerate}
